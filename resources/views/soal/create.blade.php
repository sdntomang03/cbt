<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-5 py-2">
            ...
            <div>
                <h2 class="font-black text-2xl md:text-3xl text-slate-800 tracking-tight">Buat Soal Baru</h2>
                            ...
                            <div class="space-y-3">
                                <template x-for="(opt, index) in form.options" :key="index">
                                    <div class="flex items-start gap-3 p-3 bg-slate-50 border rounded-xl transition-all"
                                        ...
                                        {{-- :data-opt-id diproses Alpine; .quill-option-target di dalam x-ignore aman
                                        dari Alpine --}}
