<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-5 py-2 w-full">
            ...
            <div class="min-w-0">
                <h2 class="font-black text-2xl md:text-3xl text-slate-800 tracking-tight truncate">Edit Soal</h2>
                    ...
                    <div class="lg:col-span-4 flex flex-col gap-4 w-full pt-1 lg:pt-0">
                        ...
                        <div class="flex-1 w-full">
                            ...
                            <select x-model="form.exam_section_id"
                                x-init="if (!form.exam_section_id) form.exam_section_id = '{{ $sections->first()->id ?? '' }}'"
                                ...
                                <option value="{{ $section->id }}">{{ $section->section?->abbreviation }} - {{ $section->section?->name }}</option>
                                @endforeach
                            </select>
                        </div>
