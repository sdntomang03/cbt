<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-black text-2xl text-slate-800 tracking-tight">Tambah User Baru</h2>
        </div>
    </x-slot>
        ...
        <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">Email
                            (Opsional)</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label
                            class="block text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">Password</label>
