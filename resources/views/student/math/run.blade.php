                                ...
                                <div x-show="currentIndex === index"
                                    ...
                                    <div>
                                        <input type="number" :id="'input-' + index" x-model="answers[q.id]"
                                            ...
                                            :class="skipped.includes(q.id) && (answers[q.id] === undefined || answers[q.id] === '')
                                            ...
                                            class="w-32 sm:w-48 md:w-64 text-center text-4xl sm:text-5xl md:text-6xl font-black text-indigo-700 border-4 focus:ring-0 rounded-2xl sm:rounded-3xl py-4 sm:py-6 transition-all shadow-lg placeholder-slate-300 focus:shadow-2xl focus:scale-105">
